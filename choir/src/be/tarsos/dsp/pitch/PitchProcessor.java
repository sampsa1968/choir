...
public class PitchProcessor implements AudioProcessor {
	...
	public enum PitchEstimationAlgorithm {
		...
		MPM,
		/**
		 * A YIN implementation with a faster {@link FastYin} for the implementation. Or
		 * see <a href=
		 * "http://recherche.ircam.fr/equipes/pcm/cheveign/ps/2002_JASA_YIN_proof.pdf"
		 * >the YIN article</a>.
		 */
		 ...
		 * {@link DynamicWavelet}), described in a paper by Eric Larson and Ross Maddox
		 * <a href= http://online.physics.uiuc
